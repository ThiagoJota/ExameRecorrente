...
class LaboratoriesControllerTest < ActionController::TestCase
  ...
  test "should create laboratory" do
    assert_difference('Laboratory.count') do
      post :create, laboratory: { name: @laboratory.name, password: @laboratory.password, site: @laboratory.site, user: @laboratory.user }
    end
  ...
  test "should update laboratory" do
    patch :update, id: @laboratory, laboratory: { name: @laboratory.name, password: @laboratory.password, site: @laboratory.site, user: @laboratory.user }
    assert_redirected_to laboratory_path(assigns(:laboratory))
  end
